...
describe('Lill', () => {
	...
	describe('add()', function () {
		...
		it('allows to add item to multiple different lists', function () {
			const owner2 = Lill.attach({ owner: 2 })
			const owner3 = Lill.attach({ owner: 3 })
	...
	describe('find()', function () {
		...
		it('optionally accepts third argument being context for the predicate function', function () { // eslint-disable-line max-len
			const spy = sinon.spy()
			const ctx = {}
			this.add(this.firstItem)
